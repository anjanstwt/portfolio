...
export default function Footer({ className }: { className?: string }) {
    return (
        <footer className={cn("w-full pt-8 pb-4", className)}>
            <Safari url="anjansuman.com">
                <Block className="flex flex-col sm:flex-row justify-between items-center sm:items-end gap-6 text-sm text-neutral-500">

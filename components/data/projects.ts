...
export const projects: ProjectType[] = [
    {
        ...
        tech: ['typescript', 'next.js', 'node.js', 'express.js', 'prisma', 'postgresql', 'websocket', 'docker', 'redis', 'kubernetes', 'llm', 'aws', 'razorpay', 'turnstile'],
    ...
    },
    {
        ...
        images: [],
        tech: ['typescript', 'next.js', 'node.js', 'express.js', 'prisma', 'postgresql', 'websocket', 'docker', 'redis', 'redis-cache', 'aws', 'anchor', 'solana'],

...
export const projects: ProjectType[] = [
    {
        ...
        tech: ['typescript', 'next.js', 'node.js', 'express.js', 'prisma', 'postgresql', 'websocket', 'docker', 'redis', 'kubernetes', 'langchain', 'aws', 'razorpay', 'turnstile', 'openrouter'],
    ...
    },
    {
        ...
        images: ['/projects/nocturn/page1.png', '/projects/nocturn/page2.png', '/projects/nocturn/page3.png', '/projects/nocturn/page4.png'],
        tech: ['typescript', 'next.js', 'node.js', 'express.js', 'prisma', 'postgresql', 'websocket', 'docker', 'redis', 'redis-cache', 'aws', 'anchor', 'solana', 'dodo payments', 'Langgraph'],
        live: 'https://nocturn.app',

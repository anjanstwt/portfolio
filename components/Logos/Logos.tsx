...
export const Logos: LogoItem[] = [
    ...
    { name: "nodeJS", url: "https://img.icons8.com/?size=100&id=54087&format=png&color=FFFFFF" },
    { name: "expressJS", url: "https://img.icons8.com/?size=100&id=SDVmtZ6VBGXt&format=png&color=FFFFFF" },
    { name: "reactJS", url: "https://img.icons8.com/?size=100&id=NfbyHexzVEDk&format=png&color=FFFFFF" },
    { name: "nextJS", url: "https://img.icons8.com/?size=100&id=MWiBjkuHeMVq&format=png&color=FFFFFF" },
    { name: "tailwindCSS", url: <Tailwind className="size-full " /> },
    { name: "prisma ORM", url: "https://img.icons8.com/?size=100&id=aqb9SdV9P8oC&format=png&color=FFFFFF" },
